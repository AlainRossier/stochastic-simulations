...
void solutions_ps2() {
    ...
    out << "\n3. Strong convergence of the Ornstein Uhlenbeck process with steps 2h." << endl;
    ...
    out << "Analysis of the strong convergence of GBM SDE with N = " << n_paths << + " paths and " << n_levels << " levels, with the 2h trick." << endl;
    double initial_vola(0.25), zeta(0.5), rho(-0.1); theta = 0.25; kappa = 2;
